            ...
            <Container className="min-h-full pt-24 pb-8 border-neutral-200 dark:border-neutral-700">
                ...
                <div className="flex flex-col gap-4 mt-8">
                    {allBlogs.map((blog, idx) => (
                        <Link key={idx} href={`/blog/${blog?.slug}`} className="bg-neutral-100 dark:bg-[#302730] p-4 rounded-lg hover:shadow-derek transition-all duration-100 ease-in-out border-1 border-neutral-200 dark:border-neutral-700 dark:hover:shadow-[var(--shadow-derek)]">
