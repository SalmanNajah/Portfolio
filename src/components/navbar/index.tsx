...
const Navbar = () => {
  ...
  return (
    <Container>
      <motion.nav className="md:fixed md:inset-x-0 md:top-0 md:max-w-4xl md:mx-auto flex items-center justify-between md:py-4 rounded-full px-6 mt-2 backdrop-blur-md bg-white/30 dark:bg-zinc-900/30"
        animate={{
